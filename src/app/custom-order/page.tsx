...
const CustomOrderPage: React.FC = () => {
  ...
  const inputStyle =
    "w-full bg-slate-50 border border-slate-200 p-3 rounded-lg text-slate-900 font-bold text-sm placeholder:text-slate-300 focus:bg-white focus:border-[#FDB813] outline-none transition-all duration-200";
  ...
  return (
    <div className="min-h-screen bg-[#F1F5F9] text-slate-900 pt-12 pb-32 px-4 font-sans">
      <div className="max-w-2xl mx-auto">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-slate-400 hover:text-slate-900 mb-6 transition-colors font-black text-[9px] uppercase tracking-widest cursor-pointer"
        >
        ...
        <div className="space-y-1">
          ...
          <section className={sectionClasses}>
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <label className={labelClasses}>
                  <FaBoxOpen size={9} /> What are we looking for?
                </label>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`h-12 rounded-lg font-black text-[9px] uppercase tracking-widest transition-all border cursor-pointer ${
                      fulfillment === "pickup"
              ...
              {fulfillment === "delivery" && (
                <div className="space-y-1 pt-1 animate-in fade-in slide-in-from-top-1">
                  <label className={labelClasses}>
                    <FaMapMarkerAlt size={9} /> Delivery Location
                  </label>
          ...
          <section className={sectionClasses}>
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <label className={labelClasses}>
                  <FaClock size={9} /> Urgency / Timeline
                </label>
              ...
              <div className="space-y-1">
                <label className={labelClasses}>
                  <FaEdit size={9} /> Special Instructions
                </label>
          ...
          <div className="fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 p-4 z-50">
            <div className="max-w-2xl mx-auto flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="flex-1 bg-[#FDB813] text-black h-14 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-yellow-500 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-[0.98] cursor-pointer"
              >
