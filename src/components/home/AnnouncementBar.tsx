...
const AnnouncementBar: React.FC = () => {
  ...
  return (
    <div className="bg-gold-strong text-background py-2.5 px-4 relative z-[60] overflow-hidden">

      <div className="absolute top-0 left-0 w-full h-full bg-background/5 animate-pulse" />
